  ...
  function(ko, Context, moduleUtils, KnockoutTemplateUtils, CoreRouter, ModuleRouterAdapter, KnockoutRouterAdapter, UrlParamAdapter, ResponsiveUtils, ResponsiveKnockoutUtils, ArrayDataProvider, OffcanvasUtils) {
     ...
     function ControllerViewModel() {
      ...
      let navData = [
        ...
        { path: 'incidents', detail: { label: 'First', iconClass: 'oj-ux-ico-artifacts' } },
        { path: 'dashboard', detail: { label: 'Second', iconClass: 'oj-ux-ico-bar-chart' } },
        { path: 'customers', detail: { label: 'Third', iconClass: 'oj-ux-ico-contact-group' } },
        { path: 'about', detail: { label: 'Fourth', iconClass: 'oj-ux-ico-information-s' } }
      ];
